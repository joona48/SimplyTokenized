...
export default function UserMenu() {
  return (
    <div className="flex justify-end items-center pr-1"> {/* Moves it slightly left from the right edge */}
        ...
        <div>
          <Menu.Button className="rounded-full w-5 h-8 overflow-hidden focus:outline-none focus:ring-2 focus:ring-cyan-400">
            <img
              ...
              alt="Profile"
              className="w-6 h-6 object-cover" // Reduced size from w-7/h-7
            />
          </Menu.Button>
        </div>
          ...
          <Menu.Items className="absolute right-0 mt-5 w-64 origin-top-right bg-white rounded-[10px] shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50 p-0">
            <div className="font-poppins p-4 border-b border-gray-200">
              ...
              <div className="flex items-center mt-3 mb-3">
                ...
                <div>
                  <p className="text-sm font-semibold max-w-[10rem] truncate text-[#27383D]">Liya Jacob</p>
                  <p className="text-sm font-normal text-[#27383D]">liya2004jacob@gmail.com</p>
                </div>
              </div>
            </div>
